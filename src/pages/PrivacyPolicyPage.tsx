...
import {
    LockOutlined, PeopleOutline, PersonAdd,
    LocationOn, InfoOutlined, ShieldOutlined, ReportProblemOutlined,
    ChildCareOutlined, UpdateOutlined, EmailOutlined, BalanceOutlined,
    AssignmentIndOutlined, GavelOutlined, StorageOutlined, CookieOutlined,
    ShareOutlined, VerifiedUserOutlined,
...
function buildSections(t: TFunction): PolicySection[] {
    ...
    return [
        ...
        },
        {
            ...
            subsections: [{ title: '', paragraphs: [t(`${p}.s4.p2`), t(`${p}.s4.p3`)] }],
        },
        {
            id: '5',
            title: t(`${p}.s5.title`),
        ...
        },
        {
            ...
            paragraphs: [
                t(`${p}.s12.p1`), t(`${p}.s12.p2`), t(`${p}.s12.p3`),
                t(`${p}.s12.p4`), t(`${p}.s12.p5`), t(`${p}.s12.p6`),
                t(`${p}.s12.p7`),
            ],
        },
        {
    ...
    return (
        <Box sx={{ minHeight: '100vh', background: pageBg, position: 'relative', pb: 8 }}>
                ...
                >
                    <Box sx={{
                        ...
                        <Box sx={{
                            ...
                            <Box component="img" src={prajakeeyaLogo} alt={t('privacyPolicy.header.logoAlt')}
                            ...
                            {section.subsections?.map((sub, si) => (
                                <Box key={si} sx={{ mt: sub.title ? 2 : 1 }}>
                                        ...
                                        <Box sx={{
                                            ...
                                            {sub.icon && (
                                                <Box sx={{
                                                    ...
                                                    background: isDark ? 'rgba(245,168,0,0.1)' : 'rgba(200,24,10,0.07)',
                                                    color: isDark ? BRAND.yellow : BRAND.red,
                                                    '& svg': { fontSize: '1rem' },
                                                }}>
                                                    {sub.icon}
                                    ...
                                    {sub.paragraphs?.map((p, pi) => (
                                        <Typography key={pi} sx={{ fontSize: '0.92rem', color: bodyText, lineHeight: 1.8, mb: 1 }}>
                                            {p}
                                        </Typography>
                                    ))}
                                    {sub.bullets && (
            ...
            <Box
                ...
                sx={{
                    maxWidth: 860, mx: 'auto', px: isMobile ? 2 : 4, mt: 3,
                    textAlign: 'center',
                }}
            >
                <Typography sx={{ fontSize: '0.8rem', color: dimText }}>
                    {t('privacyPolicy.footer.copyright', { year: new Date().getFullYear() })}
                </Typography>
