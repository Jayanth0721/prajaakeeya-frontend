...
import {
    InfoOutlined, GavelOutlined, VerifiedUserOutlined, PersonOutlined,
    HowToVoteOutlined, GroupOutlined, WarningOutlined,
    BlockOutlined, ArticleOutlined, DoneOutlined, BalanceOutlined,
...
export default function TermsAndConditionsPage() {
    ...
    return (
        <Box sx={{ minHeight: '100vh', background: pageBg, position: 'relative', pb: 8 }}>
                ...
                >
                    <Box sx={{
                        ...
                        <Box sx={{
                            ...
                            <Box component="img" src={prajakeeyaLogo} alt={t('termsAndConditions.header.logoAlt')}
            ...
            >
                <Typography sx={{
                    fontSize: '0.87rem', color: dimText, lineHeight: 1.7,
                }}>
